...
# Download plugin into eclipse directory "dropins"
# (re)start Eclipse
# verify that plugin installed as shown in attachment installed.png for Help -> About Eclipse -> Installation Details -> Plug-ins
probably reload configuration of projects : Maven -> Update Project Configuration... -> Select All -> plugin is available
...
#* maven-license-plugin - http://code.google.com/p/maven-license-plugin/issues/detail?id=102
